...
<div class="lead container">
    <div class="table-responsive">
        ...
        <div style="text-align:center">
            <h3>
                <small class="lead">Search for a pet that best matches your needs!</small>
            </h3>
        </div>
        <img class="img-fluid img-thumbnail"
             src="http://www.rentcafe.com/dmslivecafe/UploadedImages/fd506291-25cb-4339-b94e-14b01fef1bea.jpg">
        ...
        foreach ($cols as &$col) {
            ...
            if ($col == 'Gender') {
                ...
                @$f = $_POST['Fee'];
                $vars[] = $f;
            } elseif ($col == 'Sterilized') {
                @$ster = $_POST['Sterilized'];
                $vars[] = $ster;
            } elseif ($col == 'State') {
                @$stat = $_POST['State'];
                $vars[] = $stat;
        ...
        echo '<p><div style="text-align:center">
                <button type="submit" class="btn btn-outline-light slidebottomright""><h2 class="lead"><strong>Search</strong></h2></button>
            </div></p></form>';
