...
<div class="container">
    ...
    <h1 class="my-4">Pets
		...
		<?php
			...
			// SEARCH -> pets2.php
			echo '<div style="text-align:center"><p class="lead">Search for a pet that best matches your needs or choose one directly from our database here.</p>';
			echo '<form action="pets2.php"><input class="button" type="submit" name="enter" value="Search"/></form><br/>';
			echo '<form action="add.html"><input class="button" type="submit" name="enter" value="Add your pet"/></form><br/></div>';
