...
<div class="lead container">
    ...
    // SEARCH -> pets2.php
    echo '<p class="lead"><div style="text-align:center"><p class="lead">Search for a pet that best matches your needs or choose one directly from our database here.</p>';
    echo '<p><form action="pets2.php"><input class="button" type="submit" name="enter" value="Search"/></form></p></div>';
